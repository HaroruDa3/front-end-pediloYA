...
export const Restaurantes = () => {
  ...
  useEffect(() => {
    if (selectedRestaurante) {
      const restauranteId = parseInt(selectedRestaurante, 10);
      const productosFiltrados = productos.filter(producto => producto.restaurante_id === restauranteId);
      setProductosFiltrados(productosFiltrados);
    } else {
      setProductosFiltrados([]);
    }
  }, [selectedRestaurante, productos]);
  ...
  return (
    <>
      <section className='h-auto w-100 mb-4'>
        <h2 className='text-center mb-5'>Restaurantes</h2>
        <div className='d-flex justify-content-center'>
          ...
          >
            ...
            {restaurantes.map((restaurante) => (
              <option key={restaurante.restaurante_id} value={restaurante.restaurante_id}>
